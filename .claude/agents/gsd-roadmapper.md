...
Reference full template: `D:/workspace/cc/brt-pocket/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/workspace/cc/brt-pocket/.claude/get-shit-done/templates/state.md`.
